...
export default class LwcHcpUserRegistrationColombia extends LightningElement {
    //urls
    ...
    confirmEmailFocus(event) {
       const style = document.createElement('style');
        style.innerText = `c-lwc-hcp-user-registration-colombia .email-address .slds-input {
            color: transparent;
    ...
    validateEmailAddress(event) {
        ...
        validateEmailAddressFunc(inputCmp, 'Colombia', this.hcpEmailExists, this.hcpEmailInvalid, this.template, this.tabEventInProgress)
        .then(result => {

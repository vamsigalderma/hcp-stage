...
export default class LwcHcpUserRegistrationChile extends LightningElement {
    ...
    confirmEmailFocus(event) {
       const style = document.createElement('style');
        style.innerText = `c-lwc-hcp-user-registration-taiwan .email-address .slds-input {
            color: transparent;
    ...
    validateEmailAddress(event) {
        ...
        validateEmailAddressFunc(inputCmp, 'Taiwan', this.hcpEmailExists, this.hcpEmailInvalid, this.template, this.tabEventInProgress)
        .then(result => {

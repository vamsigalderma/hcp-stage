...
export default class lwcHcpUserRegistrationSouthAfrica extends LightningElement {
    //urls
    ...
    confirmEmailFocus(event) {
       const style = document.createElement('style');
        style.innerText = `c-lwc-hcp-user-registration-south-africa .email-address .slds-input {
            color: transparent;
    ...
    validateEmailAddress(event) {
        ...
        validateEmailAddressFunc(inputCmp, 'South Africa', this.hcpEmailExists, this.hcpEmailInvalid, this.template, this.tabEventInProgress)
        .then(result => {

...
export default class lwcHcpUserRegistrationSingapore extends LightningElement {
    //urls
   ...
   confirmEmailFocus(event) {
      const style = document.createElement('style');
       style.innerText = `c-lwc-hcp-user-registration-singapore .email-address .slds-input {
           color: transparent;
   ...
   confirmEmailValidateEvent() {
    ...
    connectedCallback() {
       /* setTimeout(() =>
        this.template.querySelector('[name="profession"]').selectedIndex = 1);*/
    ...
    validateEmailAddress(event) {
        ...
        validateEmailAddressFunc(inputCmp, 'Singapore', this.hcpEmailExists, this.hcpEmailInvalid, this.template, this.tabEventInProgress)
        .then(result => {

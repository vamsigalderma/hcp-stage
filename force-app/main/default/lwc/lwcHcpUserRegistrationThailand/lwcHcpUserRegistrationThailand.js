...
import HCP_MIDDLE_NAME from '@salesforce/label/c.HCPMiddleName';
...
export default class lwcHcpUserRegistrationThailand extends LightningElement {
    //urls
    ...
    confirmEmailFocus(event) {
       const style = document.createElement('style');
        style.innerText = `c-lwc-hcp-user-registration-thailand .email-address .slds-input {
            color: transparent;
    ...
    validateEmailAddress(event) {
        ...
        validateEmailAddressFunc(inputCmp, 'Thailand', this.hcpEmailExists, this.hcpEmailInvalid, this.template, this.tabEventInProgress)
        .then(result => {
